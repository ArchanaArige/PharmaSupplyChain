...
async function getContractInstance() {
	...
	// Credentials for user TRANSPORTER_ADMIN was initially added to this wallet.
	...
	let connectionProfile = yaml.safeLoad(fs.readFileSync('./connection-profile-transporter.yaml', 'utf8'));
