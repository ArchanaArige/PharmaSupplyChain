...
app.post('/addDrug', (req, res) => {
    addDrug.execute(req.body.drugName, req.body.serialNo, req.body.mfgDate, req.body.expDate, req.body.companyCRN).then((drug) => {
        console.log('addDrug request submitted on the Network');
        const result = {
            status: 'success',
